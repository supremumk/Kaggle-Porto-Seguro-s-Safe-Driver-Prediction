...
nn_params['alpha'] = 1e-5
nn_params['hidden_layer_sizes'] = (100,50,20)
nn_params['random_state'] = 1

nn_model1 = MLPClassifier(**nn_params)

# Neural network classifier
nn_params2 = {}
nn_params2['solver'] = 'lbfgs'
nn_params2['alpha'] = 1e-5
nn_params2['hidden_layer_sizes'] = (200,100,50,20,10,5)
nn_params2['random_state'] = 1

nn_model2 = MLPClassifier(**nn_params2)
...
#                  stacker=log_model,
#                  base_models=(nn_model1,ada_model1,xgb_model,lgb_model,lgb_model2,lgb_model3))
# y_pred = stack.fit_predict(train, target_train, test)

# stack = Ensemble(n_splits=3,
#                  stacker=log_model,
#                  base_models=(AdaBoostClassifier(DecisionTreeClassifier(max_depth=2),n_estimators=600,learning_rate=1)))
bdt_real = AdaBoostClassifier(
    lgb_model3,
    n_estimators=50,
    learning_rate=0.5)
#bdt_real.fit(train, target_train)
# Set up classifier
...
# stack models
stack_lgb = Ensemble(n_splits=5,
                 stacker=log_model1,
                 base_models=(lgb_model,lgb_model2,lgb_model3))

stack_xgb = Ensemble(n_splits=5,
                 stacker=log_model2,
                 base_models=(XGBC_model,XGBC_model2,XGBC_model3))

stack_nn = Ensemble(n_splits=5,
                 stacker=log_model3,
                 base_models=(nn_model1,nn_model2))

stack = Ensemble(n_splits=10,
                 stacker=log_model,
                 base_models=(stack_lgb,stack_xgb))
...
for i, (train_index, test_index) in enumerate(kf.split(train_df)):
    ...
    pred=stack.predict_proba(X_valid)[:,1]
